...
class Notification implements NotificationInterface {
  ...
  public function sendNotification(EntityInterface $entity, array $notifications) {
    ...
    foreach ($notifications as $notification) {
      ...
      $data['to'] = implode(',', array_unique($data['to']));
      ...
      $this->mailManager->mail('content_moderation_notifications', 'content_moderation_notification', $data['to'], $data['langcode'], $data['params'], NULL, TRUE);
    }
  }
